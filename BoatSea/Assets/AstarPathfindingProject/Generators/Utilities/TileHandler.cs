			...
			while ( true ) {
				...
				for (int cmode=0; cmode < 16; cmode++) {
					...
					if (1 << cmode == (int)CutMode.CutAll) {
						...
						sol.Clear();
						clipper.Execute(ClipperLib.ClipType.ctDifference, sol, PolyFillType.pftEvenOdd, PolyFillType.pftNonZero);
						...
						sol2.Clear();
						clipper.Execute(ClipperLib.ClipType.ctIntersection, sol2, PolyFillType.pftEvenOdd, PolyFillType.pftNonZero);
						...
						clipper.Execute(ClipperLib.ClipType.ctIntersection, sol, PolyFillType.pftEvenOdd, PolyFillType.pftNonZero);
					}
